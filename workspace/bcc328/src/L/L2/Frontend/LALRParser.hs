...
happyExpList = Happy_Data_Array.listArray (0,83) ([0,0,0,8192,4656,0,0,2048,0,16,64,0,1,512,0,0,0,64,480,0,1,7680,0,0,0,60,0,0,0,0,0,480,0,4096,57344,3,120,0,4156,0,0,30,30720,0,480,32768,7,2048,0,3968,0,0,2048,0,0,0,0,12288,0,192,0,0,12320,10,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_l2Parser","L2","Stmts","Stmt","Expr","NUMBER","STRING","IDENT","'('","')'","'+'","'-'","'*'","'/'","'read'","'print'","':='","';'","','","'def'","'in'","'end'","EOF","%eof"]
...
action_19 (7) = happyGoto action_30
...
action_22 (11) = happyShift action_19
...
action_29 (10) = happyShift action_32
...
action_32 (12) = happyShift action_39
...
happyReduction_5 (HappyAbsSyn7  happy_var_3)
	...
	(HappyTerminal (Token _ (TIdent happy_var_1)))
	 =  HappyAbsSyn6
		 (LAssign happy_var_1 happy_var_3
	)
...
happyReduction_8 (_ `HappyStk`
	...
	happyRest)
	 = HappyAbsSyn6
		 (Def happy_var_2 happy_var_4 (reverse happy_var_6)
	) `HappyStk` happyRest

happyReduce_9 = happySpecReduce_1  7 happyReduction_9
happyReduction_9 (HappyTerminal (Token _ (TNumber happy_var_1)))
	 =  HappyAbsSyn7
...
happyReduction_10 (HappyTerminal (Token _ (TString happy_var_1)))
	 =  HappyAbsSyn7
...
happyNewToken action sts stk (tk:tks) =
	...
	Token _ TDef -> cont 22;
	Token _ TIn -> cont 23;
	Token _ TEnd -> cont 24;
	Token _ TEOF -> cont 25;
	_ -> happyError' ((tk:tks), [])
	}
...
l2Parser tks = happyRunIdentity happySomeParser where
